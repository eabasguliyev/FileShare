<?php
    /**
     *  File Helper contains useful methods and flags
     */
    class FileHelper{
        const FILE_ATTR_PUBLIC = 0;
         ...
         *  @param string $path directory will be created in this path
         *  @param bool $isStrong if strong enabled directory name length will up to 23 characters otherwise 17
         *  @return string created directory path
         */
        public static function createRandomDir($path, $isStrong = false){
            do{
                $dirName = uniqid('dir_', $isStrong);
                $path .= '\\' . $dirName;
